	...
	<div id="main-menu" role="navigation">
		<div id="main-menu-inner">
			...
			<ul class="navigation">
				...
				<li>
					<a href="users"><i class="menu-icon fa fa-user"></i><span class="mm-text">Users</span></a>
					
				</li>
				<li>
					<a href="projects"><i class="menu-icon fa fa-file"></i><span class="mm-text">Projects</span></a>
					
				</li>
				<li>
					<a href="timereport"><i class="menu-icon fa fa-th"></i><span class="mm-text">Time Reports</span></a>
